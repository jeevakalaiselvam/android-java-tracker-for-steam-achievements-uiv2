...
public class ZUtils {
    ...
    public ZUtils(Activity activity) {
        ...
        STEAM_KEY = "777E368255E8B993B39D50433499C608"; //JEEVA
        //STEAM_KEY = "DF0981802478FB39A34392CCA1198FC5"; //SINDU
    ...
    public static String getAchievmentProgress(String gameID) {
        return "https://steamcommunity.com/id/notreallogan/stats/" + gameID + "/achievements/";
    }
    ...
    public void logAchievement(Achievement achievement,String header){
        logError(
                "\n--------------------------------------" + header + "-------------------------------------------------"
                        ...
                        + "\nUNLOCKTIME: " + achievement.getUnlockTime()
                        + " ----------------------------------------------------------------------------------------------------");
    }
}
