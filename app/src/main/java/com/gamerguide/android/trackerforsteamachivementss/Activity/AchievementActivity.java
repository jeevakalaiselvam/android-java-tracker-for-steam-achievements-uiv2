...
public class AchievementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Variable reference declarations to UI elements
        ...
        //Check if a achievement is present to the right and show it when pressed
        ...
        //Check if a achievement is present to the left and show it when pressed
    ...
    //Setup achivement data based on position of the achievement in achivement array
